          ...
          <div>
            <div style={styles.reportHeader}>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <button style={styles.downloadBtn} onClick={() => downloadReport(fria, 'fria_report.json')}>
                  Download Report
                </button>
              </div>
            </div>
          ...
          <div>
            <div style={styles.reportHeader}>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <button style={styles.downloadBtn} onClick={() => downloadReport(cybersecurity, 'cybersecurity_report.json')}>
                  Download Report
                </button>
              </div>
            </div>
          ...
          <div>
            <div style={styles.reportHeader}>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <button style={styles.downloadBtn} onClick={() => downloadReport(xai, 'xai_report.json')}>
                  Download Report
                </button>
              </div>
            </div>
          ...
          <div>
            <div style={styles.reportHeader}>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <button style={styles.downloadBtn} onClick={() => downloadReport(risk, 'risk_report.json')}>
                  Download Report
                </button>
              </div>
            </div>
            ...
            <div style={styles.ragRow}>
              <div style={{ ...styles.ragCard, backgroundColor: '#fff5f5', borderColor: '#e53e3e' }}>
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#e53e3e' }}>
                  {risk.risk_summary?.high_risks}
                </div>
              ...
              <div style={{ ...styles.ragCard, backgroundColor: '#fffff0', borderColor: '#d69e2e' }}>
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#d69e2e' }}>
                  {risk.risk_summary?.medium_risks}
                </div>
              ...
              <div style={{ ...styles.ragCard, backgroundColor: '#EBF5FB', borderColor: '#2E75B6' }}>
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#2E75B6' }}>
                  {risk.overall_risk_score}/10
                </div>
          ...
          <div>
            <div style={styles.reportHeader}>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <button style={styles.downloadBtn} onClick={() => downloadReport(bias, 'bias_report.json')}>
                  Download Report
                </button>
              </div>
            </div>
            ...
            {Object.entries(bias.fairness_analysis || {}).map(([key, analysis]) => (
              <div key={key}>
                ...
                <p style={{ fontSize: '14px', color: '#718096', marginBottom: '16px' }}>
                  Comparing: {analysis.group_a} vs {analysis.group_b}
                </p>

                {Object.entries(analysis).filter(([k]) => !['group_a', 'group_b'].includes(k)).map(([metric, data]) => (
...
const styles = {
  ...
  backBtn: { padding: '12px 28px', borderRadius: '8px', border: 'none', backgroundColor: '#2E75B6', color: 'white', cursor: 'pointer', fontSize: '15px', marginTop: '16px' },
  ...
  tabsSection: { backgroundColor: 'white', borderBottom: '1px solid #e2e8f0', position: 'sticky', top: 0, zIndex: 10 },
  ...
  downloadBtn: { padding: '10px 20px', borderRadius: '8px', border: '1px solid #e2e8f0', backgroundColor: 'white', color: '#2E75B6', cursor: 'pointer', fontSize: '14px', fontWeight: '600' },
